...
use App\Jobs\AutoScaleSwarmJob;
...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        if (isDev()) {
            ...
            // Auto-scaling for Swarm deployments
            $this->scheduleInstance->job(new AutoScaleSwarmJob)->everyMinute()->onOneServer();

            // AI Log Monitor (Self-Healing)
            $this->scheduleInstance->job(new AiLogMonitorJob)->everyFiveMinutes()->onOneServer();
