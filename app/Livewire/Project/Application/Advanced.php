...
class Advanced extends Component
{
    ...
    {
        return AccessList::orderBy('name')->get()->toArray();
    }

    #[Validate(['nullable', 'numeric'])]
    public ?string $accessListId = null;
    ...
    #[Validate(['boolean'])]
    public bool $isAiAutoFixEnabled = true;

    #[Validate(['boolean'])]
    public bool $isAiPushToGitEnabled = false;
    ...
    public function syncData(bool $toModel = false)
    {
        if ($toModel) {
            ...
            $this->application->settings->is_ai_auto_fix_enabled = $this->isAiAutoFixEnabled;
            $this->application->settings->is_ai_push_to_git_enabled = $this->isAiPushToGitEnabled;
            $this->application->settings->access_list_id = $this->accessListId ?: null;
            ...
            $this->isAiAutoFixEnabled = $this->application->settings->is_ai_auto_fix_enabled ?? true;
            $this->isAiPushToGitEnabled = $this->application->settings->is_ai_push_to_git_enabled ?? false;
            $this->accessListId = (string) $this->application->settings->access_list_id ?? null;
        }
    }
