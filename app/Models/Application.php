...
#[OA\Schema(
    ...
    properties: [
        ...
        'build_pack' => ['type' => 'string', 'description' => 'Build pack.', 'enum' => ['nixpacks', 'static', 'dockerfile', 'dockercompose', 'ai']],
        ...
        'swarm_service_identifier' => ['type' => 'string', 'nullable' => true, 'description' => 'Unique identifier for swarm load balancer routing.'],
        'auto_scaling_enabled' => ['type' => 'boolean', 'description' => 'Enable auto-scaling for swarm deployments.'],
        'auto_scaling_min_replicas' => ['type' => 'integer', 'description' => 'Minimum number of replicas for auto-scaling.'],
        'auto_scaling_max_replicas' => ['type' => 'integer', 'description' => 'Maximum number of replicas for auto-scaling.'],
        'auto_scaling_target_cpu' => ['type' => 'integer', 'description' => 'Target CPU percentage for auto-scaling.'],
        'auto_scaling_target_memory' => ['type' => 'integer', 'description' => 'Target memory percentage for auto-scaling.'],
...
class Application extends BaseModel
{
    ...
    protected $casts = [
        ...
        'swarm_service_identifier' => 'string',
    ];
    ...
    protected static function booted()
    {
        static::addGlobalScope('withRelations', function ($builder) {
            ...
            // Note: additional_networks count removed due to query issues with polymorphic relationships
        });
    ...
    public function swarmDomainMappings()
    {
        return $this->hasMany(SwarmDomainMapping::class);
    }
