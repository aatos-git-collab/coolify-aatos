            ...
            <div class="flex flex-col dark:text-white dark:border-coolgray-300 border-neutral-200"
                ...
                <div
                    ...
                    <div class="flex flex-wrap items-center justify-end gap-2 flex-1">
                        ...
                        {{-- AI Analyze Button (Sparkle) --}}
                        <button wire:click="analyzeWithAi" title="AI Analyze Logs"
                            wire:loading.class="opacity-50"
                            wire:loading.attr="disabled"
                            class="p-1 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                            <svg wire:loading.remove class="w-4 h-4" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-width="2">
                            ...
                            <svg wire:loading class="w-4 h-4 animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                            </svg>
                        </button>
                ...
                @if ($ai_analysis_result)
                    <div class="p-4 border-t border-neutral-200 dark:border-coolgray-700 bg-coolgray-100 dark:bg-coolgray-200">
                        <div class="flex items-center justify-between mb-2">
                            <h4 class="font-bold text-warning dark:text-white">AI Analysis</h4>
                            <div class="flex gap-2">
                                <x-forms.button wire:click="applyFix" class="text-xs">
                                ...
                                <button wire:click="$set('ai_analysis_result', null)" class="text-xs text-gray-500 hover:text-gray-700">
                                    ✕ Close
                                </button>
                            </div>
                        </div>
                        <pre class="text-sm whitespace-pre-wrap font-mono text-neutral-200 dark:text-neutral-300">{{ $ai_analysis_result }}</pre>
                    </div>
                @endif
            </div>
        </div>
