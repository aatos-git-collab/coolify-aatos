                ...
                <div @if ($isKeepAliveOn) wire:poll.2000ms="polling" @endif
                    ...
                    <div
                        ...
                        <div class="flex flex-wrap items-center justify-end gap-2 flex-1">
                            ...
                            {{-- AI Debug Button --}}
                            <button wire:click="analyzeWithAi" title="AI Debug"
                    ...
                    @if ($ai_analysis_result)
                        <div class="p-4 mt-2 border rounded bg-coolgray-100 dark:bg-coolgray-200 border-warning">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <x-forms.button wire:click="redeploy" class="text-xs">
                                        <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                                        </svg>
                                        Rebuild
                                    </x-forms.button>
                                    <x-forms.button wire:click="restart" class="text-xs">
                                        <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                                        </svg>
                                        Restart
